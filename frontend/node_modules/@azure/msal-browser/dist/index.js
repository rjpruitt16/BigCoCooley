/*! @azure/msal-browser v2.0.0-alpha.0 2020-01-18 */
'use strict';
'use strict';
...
var ServerCodeRequestParameters = /** @class */ (function (_super) {
    __extends$1(ServerCodeRequestParameters, _super);
...
var ServerTokenRequestParameters = /** @class */ (function (_super) {
    __extends$1(ServerTokenRequestParameters, _super);
...
var ResponseHandler = /** @class */ (function () {
    ...
    ResponseHandler.prototype.saveToken = function (originalTokenResponse, authority, resource, serverTokenResponse, clientInfo) {
        ...
        return __assign$1(__assign$1({}, originalTokenResponse), { scopes: responseScopeArray, accessToken: serverTokenResponse.access_token, refreshToken: serverTokenResponse.refresh_token, expiresOn: new Date(expirationSec * 1000) });
    };
    /**
...
var BrowserUtils = /** @class */ (function () {
     ...
     */
    BrowserUtils.navigateWindow = function (urlNavigate) {
            ...
            return __generator(this, function (_a) {
                ...
                if (this.hasIECrypto()) {
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            var digestOperation = window["msCrypto"].subtle.digest(HASH_ALG, data.buffer);
                ...
                return [2 /*return*/, window.crypto.subtle.digest(HASH_ALG, data)];
            });
        });
    };
    /**
...
var RedirectHandler = /** @class */ (function (_super) {
    ...
    function RedirectHandler(authCodeModule, storageImpl, navigateToLoginRequestUrl) {
        var _this = _super.call(this, authCodeModule, storageImpl) || this;
        _this.navigateToLoginRequestUrl = navigateToLoginRequestUrl;
        return _this;
    }
    /**
    ...
    RedirectHandler.prototype.handleCodeResponse = function (locationHash) {
        return __awaiter(this, void 0, void 0, function () {
            var loginRequestUrl, codeResponse;
            return __generator(this, function (_a) {
...
var PopupHandler = /** @class */ (function (_super) {
    ...
    PopupHandler.prototype.showUI = function (requestUrl) {
        ...
        if (!StringUtils.isEmpty(requestUrl)) {
            ...
            var popupWindow = this.openPopup(requestUrl, Constants.LIBRARY_NAME, BrowserConstants.POPUP_WIDTH, BrowserConstants.POPUP_HEIGHT);
...
var PublicClientApplication = /** @class */ (function () {
    ...
    PublicClientApplication.prototype.handleRedirectCallback = function (authCallback) {
        return __awaiter(this, void 0, void 0, function () {
            var hash, cachedHash, interactionHandler, responseHash, tokenResponse, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        interactionHandler = new RedirectHandler(this.authModule, this.browserStorage, this.config.auth.navigateToLoginRequestUrl);
                        responseHash = UrlString.hashContainsKnownProperties(hash) ? hash : cachedHash;
                        if (!responseHash) return [3 /*break*/, 3];
    ...
    PublicClientApplication.prototype.loginRedirect = function (request) {
        ...
        var interactionHandler = new RedirectHandler(this.authModule, this.browserStorage, this.config.auth.navigateToLoginRequestUrl);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, interactionHandler.handleCodeResponse(hash)];
                }
            });
        });
    };
